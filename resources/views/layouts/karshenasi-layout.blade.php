...
<script>
    ...
    document.addEventListener('livewire:init', function () {
        // console.log('load')
        // Example: price animation
        Livewire.on('priceUpdated', price => {
            // console.log('priceUpdated')
            const priceEl = document.getElementById('price');
            if (!priceEl) return;
            priceEl.innerText = new Intl.NumberFormat('fa-IR').format(price);
        });
        ...
        console.log('datePicker Initiated')
            ...
            input.persianDatepicker({
                ...
                calendar: {
                    persian: { locale: 'en', leapYearMode: 'astronomical' }
                },
                onSelect: function(unix) {
                    ...
                    document.getElementById('delivery_date_picker')
        ...
        Livewire.on('step2Loaded', function(){
            initDatePicker();
        })
